  ...
  return (
    <section className="hero section-shell" id="top">
      ...
      >
        ...
        >
          Actnivo connects your marketplaces, quick-commerce channels,
          inventory and operations — finds what is costing you money,
          recommends what to do, and executes the fix.
        </motion.p>
        ...
        >
          No credit card <i /> Setup in under 30 minutes
        </motion.small>
      </motion.div>
