...
export default async function TeamPage() {
  ...
  const [membersResult, invitesResult] = await Promise.all([
    db.from("organization_members").select("id,user_id,role,created_at,profiles:user_id(full_name,email)").eq("organization_id", organization.id).order("created_at", { ascending: true }),
